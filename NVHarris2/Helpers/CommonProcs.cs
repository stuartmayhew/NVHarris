...
namespace NVHarris2.Helpers
{
    ...
    {
        public static string WCompanyConnStr = "Data Source=52.41.99.172;Initial Catalog=NVHarris2;Persist Security Info=True;User ID=sa;Password=Sh@dow111";
        //public static string WCompanyConnStr = "Data Source=localhost;Initial Catalog=NVHarris2;Persist Security Info=True;User ID=sa;Password=Sh@dow111";
